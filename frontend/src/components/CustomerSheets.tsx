          ...
          >
            ...
            <View style={styles.orderHeader}>
              ...
              <View style={[styles.statusPill, { borderColor: status.color }]}>
                <Text style={{ color: status.color, fontSize: FONT_SIZES.caption }}>{status.label}</Text>
              </View>
            </View>
...
const styles = StyleSheet.create({
  ...
  eyebrow: { color: COLORS.gold, fontSize: FONT_SIZES.caption, letterSpacing: 1.5 },
  detailTitle: { color: COLORS.bone, fontSize: FONT_SIZES.display, fontWeight: '700', marginTop: 4 },
  perfumeMeta: { color: COLORS.muted, fontSize: FONT_SIZES.bodySmall, marginTop: 3 },
  ...
  availabilityText: { fontSize: FONT_SIZES.caption, fontWeight: '700' },
  detailMeta: { color: COLORS.muted, fontSize: FONT_SIZES.bodySmall, marginTop: 3 },
  ...
  sectionLabel: { color: COLORS.gold, fontSize: FONT_SIZES.caption, letterSpacing: 1.3, marginBottom: 8 },
  ...
  sizePrice: { color: COLORS.muted, fontSize: FONT_SIZES.caption, marginTop: 2 },
  quizLead: { color: COLORS.bone, fontSize: FONT_SIZES.bodyLarge, lineHeight: 22, marginBottom: SPACING.xl },
  chips: { flexDirection: 'row', flexWrap: 'wrap', gap: 8 },
  results: { marginTop: SPACING.xl, paddingTop: SPACING.lg, borderTopWidth: 1, borderTopColor: COLORS.border },
  resultTitle: { color: COLORS.bone, fontSize: FONT_SIZES.title, fontWeight: '700' },
  resultSub: { color: COLORS.muted, fontSize: FONT_SIZES.bodySmall, marginTop: 4, marginBottom: SPACING.md },
  ...
  resultName: { color: COLORS.bone, fontSize: FONT_SIZES.body, fontWeight: '600' },
  ...
  orderDate: { color: COLORS.muted, fontSize: FONT_SIZES.caption, marginTop: 3 },
  ...
  cancelConfirmTitle: { color: COLORS.bone, fontSize: FONT_SIZES.bodySmall, fontWeight: '700' },
  cancelConfirmText: { color: COLORS.muted, fontSize: FONT_SIZES.caption, lineHeight: 17, marginTop: 7 },
  cancelError: { color: COLORS.rust, fontSize: FONT_SIZES.caption, lineHeight: 16, marginTop: 7 },
  ...
  cancelConfirmButtonText: { color: COLORS.inverse, fontSize: FONT_SIZES.label, fontWeight: '700' },
  removeOrderHint: { flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 6, minHeight: 34, marginTop: SPACING.sm },
  removeOrderHintText: { color: COLORS.muted, fontSize: FONT_SIZES.caption },
  ...
  removeConfirmButtonText: { color: COLORS.inverse, fontSize: FONT_SIZES.label, fontWeight: '700' },
  ...
  emptyEyebrow: { color: COLORS.gold, fontSize: FONT_SIZES.caption, letterSpacing: 1.8, textAlign: 'center' },
  emptyTitle: { color: COLORS.bone, fontSize: FONT_SIZES.titleLarge, lineHeight: 28, fontWeight: '700', textAlign: 'center', marginTop: 8, maxWidth: 300 },
  ...
  privacyText: { flex: 1, color: COLORS.bone, fontSize: FONT_SIZES.caption, lineHeight: 17 },
  ...
  recoveryLinkText: { color: COLORS.gold, fontSize: FONT_SIZES.caption, fontWeight: '600' },
  ...
  recoveryTitle: { color: COLORS.bone, fontSize: FONT_SIZES.bodyLarge, fontWeight: '700' },
  recoveryText: { color: COLORS.muted, fontSize: FONT_SIZES.caption, lineHeight: 17, marginTop: 3, marginBottom: SPACING.sm },
  recoveryError: { color: COLORS.rust, fontSize: FONT_SIZES.caption, marginTop: 7 },
