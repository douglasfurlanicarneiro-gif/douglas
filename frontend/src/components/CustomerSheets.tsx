...
const styles = StyleSheet.create({
  ...
  noteLabel: { ...TYPOGRAPHY.caption, color: COLORS.muted, width: 72, flexShrink: 0 },
  noteValue: { ...TYPOGRAPHY.bodySmall, color: COLORS.bone, flex: 1, fontStyle: 'italic' },
  ...
  sizeText: { ...TYPOGRAPHY.label, color: COLORS.bone, fontWeight: '700' },
  sizePrice: { ...TYPOGRAPHY.caption, color: COLORS.muted, marginTop: 2 },
  quizLead: { ...TYPOGRAPHY.bodyLarge, color: COLORS.bone, marginBottom: SPACING.xl },
  chips: { flexDirection: 'row', flexWrap: 'wrap', gap: 8 },
  results: { marginTop: SPACING.xl, paddingTop: SPACING.lg, borderTopWidth: 1, borderTopColor: COLORS.border },
  resultTitle: { ...TYPOGRAPHY.title, color: COLORS.bone },
  resultSub: { ...TYPOGRAPHY.bodySmall, color: COLORS.muted, marginTop: 4, marginBottom: SPACING.md },
  ...
  resultNumberText: { ...TYPOGRAPHY.label, color: COLORS.ink, fontWeight: '700' },
  resultName: { ...TYPOGRAPHY.body, color: COLORS.bone, fontWeight: '600' },
  ...
  customerSwipeRemoveText: { ...TYPOGRAPHY.caption, color: COLORS.inverse, fontWeight: '700' },
  orderHeader: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginBottom: SPACING.md },
  orderDate: { ...TYPOGRAPHY.caption, color: COLORS.muted, marginTop: 3 },
  ...
  orderItemMeta: { ...TYPOGRAPHY.caption, color: COLORS.muted, marginTop: 2 },
  ...
  couponSummaryValue: { ...TYPOGRAPHY.label, color: COLORS.sageText, fontWeight: '700' },
  ...
  timelineText: { ...TYPOGRAPHY.label, color: COLORS.bone, flex: 1 },
  timelineDate: { ...TYPOGRAPHY.caption, color: COLORS.muted },
  ...
  continuePaymentTitle: { ...TYPOGRAPHY.bodySmall, color: COLORS.ink, fontWeight: '700' },
  continuePaymentSubtitle: { ...TYPOGRAPHY.caption, color: COLORS.ink, marginTop: 2, opacity: 0.78 },
  paymentError: { flexDirection: 'row', alignItems: 'flex-start', gap: 7, paddingHorizontal: SPACING.sm, marginBottom: 8 },
  paymentErrorText: { ...TYPOGRAPHY.caption, flex: 1, color: COLORS.rust, lineHeight: 17 },
  ...
  whatsappButtonText: { ...TYPOGRAPHY.button, color: COLORS.bone, fontWeight: '700' },
  cancelOrderLink: { minHeight: 42, alignItems: 'center', justifyContent: 'center', marginTop: 5 },
  cancelOrderLinkText: { ...TYPOGRAPHY.label, color: COLORS.rust },
  ...
  cancelConfirmTitle: { ...TYPOGRAPHY.bodySmall, color: COLORS.bone, fontWeight: '700' },
  cancelConfirmText: { ...TYPOGRAPHY.caption, color: COLORS.muted, lineHeight: 17, marginTop: 7 },
  cancelError: { ...TYPOGRAPHY.caption, color: COLORS.rust, lineHeight: 16, marginTop: 7 },
  ...
  cancelConfirmButtonText: { ...TYPOGRAPHY.button, color: COLORS.inverse, fontWeight: '700' },
  removeOrderHint: { flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 6, minHeight: 34, marginTop: SPACING.sm },
  removeOrderHintText: { ...TYPOGRAPHY.caption, color: COLORS.muted },
  ...
  removeConfirmButtonText: { ...TYPOGRAPHY.button, color: COLORS.inverse, fontWeight: '700' },
  ...
  recoveryError: { ...TYPOGRAPHY.caption, color: COLORS.rust, marginTop: 7 },
